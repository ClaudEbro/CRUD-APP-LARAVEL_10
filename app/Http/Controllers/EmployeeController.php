...
class EmployeeController extends Controller
{
    ...
    public function fetchAll(){
        ...
        $output = '';
        if($emps->count() > 0){
            $output .= '<table class="table table-striped table-sm tet-center align-middle">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Avatar</th>
            ...
            echo '<h1 class="text-center text-secondary my-5">No record present in database !</h1>';
        }
    }
    ...
    //Handle employee delete ajax request
